...
I used [geoJson](https://geojson.io/) to specify the area I wanted, and @mapbox/cover handled the output.
...
The final image was created using [p5.js](http://p5js.org).

The GPU processing code, which is somewhat reusable, is in `processImage.js`
